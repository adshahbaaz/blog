...
The question that seems daunting at first, but is actually deceptively simple to solve. In fact, since the equation to solve for $W$ has been given to us and both $A_n$ and $S_n$ are random variables drawn from a defined probability distribution, we just have to implement the recursion.
